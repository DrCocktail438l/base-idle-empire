...
contract Empire {
    ...
    uint256 public constant CLAIM_COOLDOWN = 1 hours; // for demo, we can reduce later
    ...
    function claimResources() public {
        ...
        uint256 production = (p.mineLevel * 10) + (p.farmLevel * 5); // base production

        uint256 newResources = (timePassed / 3600) * production; // per hour for demo
