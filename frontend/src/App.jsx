...
function App() {
  ...
  const upgradeMine = () => {
    const cost = Math.floor(290 + (mineLevel * 150))
    if (resources >= cost) {
  ...
  const upgradeFarm = () => {
    const cost = Math.floor(360 + (farmLevel * 160))
    if (resources >= cost) {
      setResources(resources - cost)
  ...
  const upgradeTower = () => {
    const cost = Math.floor(1050 + (towerLevel * 280))
    if (resources >= cost) {
      setResources(resources - cost)
  ...
  const upgradeVault = () => {
    const cost = Math.floor(1550 + (vaultLevel * 380))
    if (resources >= cost) {
      setResources(resources - cost)
